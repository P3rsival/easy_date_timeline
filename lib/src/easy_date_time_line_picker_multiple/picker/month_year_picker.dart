...
Future<DateTime?> showMonthYearPicker({
  ...
  required DateTime lastDate,
  DateTime? currentDate,
  EasyDatePickerModeV2 initialCalendarMode = EasyDatePickerModeV2.month,
  String? cancelText,
  String? confirmText,
...
class MonthYearPicker extends StatefulWidget {
  ...
  /// - [EasyDatePickerModeV2], which defines the calendar modes.
  ...
  MonthYearPicker({
    ...
    this.cancelText,
    this.confirmText,
    this.initialCalendarMode = EasyDatePickerModeV2.month,
  ...
  final EasyDatePickerModeV2 initialCalendarMode;
...
class _MonthYearPickerState extends State<MonthYearPicker> {
  late EasyDatePickerModeV2 _mode;
  ...
  void _handleModeChanged(EasyDatePickerModeV2 mode) {
    _vibrate();
    setState(() {
      _mode = mode;
    });
  ...
  void _handleYearChanged(DateTime date) {
    _vibrate();
    _mode = EasyDatePickerModeV2.month;
  ...
  Widget _buildPicker() {
    return switch (_mode) {
      EasyDatePickerModeV2.month => EasyMonthPickerView(
          key: _monthPickerKey,
      ...
      EasyDatePickerModeV2.year => EasyYearPicker(
          key: _yearPickerKey,
          firstDate: widget.firstDate,
          lastDate: widget.lastDate,
          focusedDate: _selectedDate,
  ...
  Widget build(BuildContext context) {
    ...
    final Widget header = EasyDatePickerModeToggleButton(
      ...
      onTitlePressed: () => _handleModeChanged(switch (_mode) {
        EasyDatePickerModeV2.month => EasyDatePickerModeV2.year,
        EasyDatePickerModeV2.year => EasyDatePickerModeV2.month,
      }),
    );
