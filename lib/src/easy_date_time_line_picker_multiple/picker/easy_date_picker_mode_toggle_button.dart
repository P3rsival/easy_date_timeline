...
class EasyDatePickerModeToggleButton extends StatefulWidget {
  ...
  final EasyDatePickerModeV2 mode;
...
class _EasyDatePickerModeToggleButtonState
  ...
  void initState() {
    ...
    _controller = AnimationController(
      value: widget.mode == EasyDatePickerModeV2.year ? 0.5 : 0,
      upperBound: 0.5,
  ...
  void didUpdateWidget(EasyDatePickerModeToggleButton oldWidget) {
    ...
    if (widget.mode == EasyDatePickerModeV2.year) {
      _controller.forward();
    } else {
      _controller.reverse();
    }
      ...
      child: Padding(
        ...
        child: Row(
          children: <Widget>[
            ...
            if (widget.mode == EasyDatePickerModeV2.month)
