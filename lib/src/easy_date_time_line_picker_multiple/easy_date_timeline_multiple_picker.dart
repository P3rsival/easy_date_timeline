...
class EasyDateTimeLineMultiplePicker extends StatelessWidget {
  /// Creates an [EasyDateTimeLineMultiplePicker] with default day parts.
  ///
  ...
  EasyDateTimeLineMultiplePicker({
    ...
    this.monthYearPickerOptions = const MonthYearPickerOptions(),
        ...
        currentDates = (currentDates ?? [DateTime.now()])
  ...
  /// Creates an [EasyDateTimeLineMultiplePicker] with a custom item builder.
  ///
  ...
  EasyDateTimeLineMultiplePicker.itemBuilder({
    super.key,
    this.controller,
    required DateTime firstDate,
    required DateTime lastDate,
  ...
  /// Custom builder for day items. Only used when created with [EasyDateTimeLineMultiplePicker.itemBuilder].
  /// ```dart
  /// EasyDateTimeLineMultiplePicker.itemBuilder(
  ///   itemExtent: 64.0,
  ...
  ///
  /// The [HeaderOptionsV2] class allows you to customize the header appearance and behavior,
  ...
  Widget build(BuildContext context) {
    ...
    return DayTimeLinePickerMultipleWidget(
      controller: controller,
      firstDate: firstDate,
      lastDate: lastDate,
