...
final class EasyDatePickerMultipleController extends ScrollController
    with InfiniteTimeLineScrollMixin {
  /// Reference to the state of the DayTimeLinePickerWidget.
  _DayTimeLinePickerMultipleWidgetState? _timelineState;
  ...
  /// Attaches the controller to a [_DayTimeLinePickerMultipleWidgetState].
  ///
  /// This method is typically called internally by the widget.
  ///
  /// [anchor] The state to attach to this controller.
  void _attach(_DayTimeLinePickerMultipleWidgetState anchor) {
    _timelineState = anchor;
  }

  /// Detaches the controller from a [_DayTimeLinePickerMultipleWidgetState].
  ///
  ...
  void _detach(_DayTimeLinePickerMultipleWidgetState anchor) {
    if (_timelineState == anchor) {
      _timelineState = null;
    }
  }

  DayTimeLinePickerMultipleWidget get _widget => _timelineState!.widget;
